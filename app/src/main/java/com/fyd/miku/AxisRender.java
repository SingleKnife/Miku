...
public class AxisRender {
    ...
    public void draw() {
        GLES20.glVertexAttribPointer(vertexAttributeLocation, 3, GLES20.GL_FLOAT, false, 6 * 4, verticesBuffer);
        GLES20.glVertexAttribPointer(colorAttributeLocation, 3, GLES20.GL_FLOAT, false, 6 * 4, verticesBuffer);
